...
public class AES {
	...
	public static String createSign(SortedMap<String, String> packageParams, String pwd) {
		StringBuffer sb = new StringBuffer();
		...
		try {
			...
			String sign = AES.encrypt(md5sign, pwd);
			return sign;
	...
	public static void main(String[] args) {
		...
		try {
			...
			String decrypt = AES.decrypt("EDDA65D8C4BDF3521883E14A80D349BE", AES.key);
