...
import com.mszx.hyb.common.model.PageRequest;
...
public class ParameterMap extends HashMap implements Map {
	...
	public ParameterMap(PageRequest pageRequest) {
		Map<String, Object> pageMap = new HashMap<String, Object>();
		pageMap.put("pageNum", pageRequest.getPageNum());
		pageMap.put("pageSize", pageRequest.getPageSize());
		map = pageMap;
	}
